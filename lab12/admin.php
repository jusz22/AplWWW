...
function StworzTabeleAdmin($link)
{
    ...
    if (mysqli_query($link, $sql)) {
        echo "<p style='color: green;'>Table 'categories' created successfully or already exists.</p>\n";
    } else {
        echo "<p style='color: red;'>Error creating table: " . mysqli_error($link) . "</p>\n";
    }
    $sql = "CREATE TABLE IF NOT EXISTS page_list (
        id INT AUTO_INCREMENT PRIMARY KEY,
    ...
    if (mysqli_query($link, $sql)) {
        echo "<p style='color: green;'>Table 'page_list' created successfully or already exists.</p>\n";
    } else {
        echo "<p style='color: red;'>Error creating table: " . mysqli_error($link) . "</p>\n";
    }
